...
`endif
  ...
  wire     [NUM_PHYS_FUNC*NUM_QDMA-1:0] axis_qdma_c2h_tuser_rss_hash_valid;
  wire  [12*NUM_PHYS_FUNC*NUM_QDMA-1:0] axis_qdma_c2h_tuser_rss_hash;
...
`endif
  ...
  generate for (genvar i = 0; i < NUM_QDMA; i++) begin: qdma_if
    qdma_subsystem #(
      ...
      .s_axis_c2h_tuser_rss_hash_valid      (axis_qdma_c2h_tuser_rss_hash_valid[`getvec(NUM_PHYS_FUNC, i)]),
      .s_axis_c2h_tuser_rss_hash            (axis_qdma_c2h_tuser_rss_hash[`getvec(12*NUM_PHYS_FUNC, i)]),
